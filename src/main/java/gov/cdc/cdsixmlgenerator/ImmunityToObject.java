/*
 * This takes immunity data and extracts it before saving it to an Immunity object
 */
 ...
 * @author csnewman
 */
public class ImmunityToObject {
    
    public static void readImmunityFile(Immunity currentImmunity,Sheet sheet){
    ...
    while (rowIterator.hasNext()) {
        ...
        if (!conceptMasterList.contains(concept)){
            ...
            Concept thisConcept=currentImmunity.setConcept(concept);
       ...
       //If so, treat the line as data and store to header objects
            ...
            Concept thisConcept=(Concept) currentImmunity.conceptList.get(currentImmunity.conceptList.size()-1);
